	    ...
	    if ( have_comments() ) :
            ...
            <h2 class="comments-title">
			    ...
			    if ( '1' === $badinsoft_comment_count ) {
				    printf(
				    /* translators: 1: title. */
					    esc_html__( 'One thought on &ldquo;%1$s&rdquo;', 'badinsoft' ),
					    '<span>' . get_the_title() . '</span>'
				    );
			    } else {
				    printf( // WPCS: XSS OK.
				    /* translators: 1: comment count number, 2: title. */
					    esc_html( _nx( '%1$s thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', $badinsoft_comment_count, 'comments title', 'badinsoft' ) ),
